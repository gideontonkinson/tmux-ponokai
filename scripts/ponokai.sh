...
main() {
  ...
  if $show_powerline; then
    tmux set-window-option -g window-status-current-format \
      "#[fg=#{?#{==:#I,$first_window_index},${?client_prefix,${!client_colors[1]},${!powerline_colors[1]}},${!window_separator_colors[1]}} ,bg=${!window_separator_colors[0]}]${window_separator}\
    ...
    tmux set-window-option -g window-status-format \
      "#[fg=#{?#{==:#I,$first_window_index},${?client_prefix,${!client_colors[1]},${!powerline_colors[1]}},${!window_separator_colors[0]}} ,bg=${!window_separator_colors[0]}]${left_separator} \
      #[fg=${!window_separator_colors[0]},bg=${!window_separator_colors[1]}]#I #W${flags} \
